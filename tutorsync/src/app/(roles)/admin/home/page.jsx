...
export default function TutorHomePage() {
  ...
  const [pendingRequests, setPendingRequests] = useState([
    { id: 1, subject: "Calculus I", date: "Wednesday, 3:00 PM", location: "Library", capacity: "4 / 8" },
    { id: 2, subject: "Calculus I", date: "Wednesday, 3:00 PM", location: "Library", capacity: "4 / 8" },
  ]);

  const [todaySessions, setTodaySessions] = useState([
    { id: 3, subject: "Calculus I", time: "3:00 PM", student: "Josh S.", platform: "Zoom" },
    { id: 4, subject: "Calculus I", time: "4:00 PM", student: "Josh S.", platform: "Zoom" },
  ]);
  ...
  return (
    <main className={styles.page}>
      <section className={styles.card}>
        {/* Assuming TopHeader renders the KSU Logo and User Email */}
        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            <h2 className={styles.sectionTitle}>Pending Group Requests ({pendingRequests.length})</h2>
                ...
                <div key={session.id} className={styles.infoCard}>
                  ...
                  <div className={styles.cardBody}>
                    <div className={styles.detailsHorizontal}>
                      ...
                      <span className={styles.detailRow}>
                        <svg className={styles.icon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>
                        {session.platform}
                      </span>
                    </div>
                  </div>
            ...
            <div className={styles.listContainer}>
              {upcomingSessions.map((session) => (
                <div key={session.id} className={styles.infoCard}>
                  ...
                  <div className={styles.cardBody}>
                     <span className={styles.dateTimeUpcoming}>{session.time}</span>
                  </div>
                </div>
              ))}
            </div>
