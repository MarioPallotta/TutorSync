...
export default function GroupDetailsClient({ group }) {
  ...
  const isFull = group.Group_Members >= 8;

  const participants = [
    group.ENROLLMENTS.USERS.Name,
  ];
        ...
        <div className={styles.content}>
          ...
          <div className={styles.infoBox}>
            <p className={styles.infoLine}>
              <strong>Date:</strong> {new Date(group.Group_Date).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) || "TBD"}
            </p>
            <p className={styles.infoLine}>
              <strong>Time:</strong> {group.Group_Time ? new Date(group.Group_Time).toLocaleTimeString("en-US", { hour: "numeric", minute: "2-digit" }) : "TBD"}
            </p>
            <p className={styles.infoLine}>
          ...
          <div className={styles.participantSection}>
            <p className={styles.participantHeader}>
              Participants ({group.Group_Members} / 8)
            </p>
